...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.checkBoxEinzelpaket.setGeometry(QRect(70, 350, 251, 61))
        font1 = QFont()
        ...
        self.ButtonDatenSenden.setGeometry(QRect(610, 350, 261, 61))
        ...
        self.ButtonOpenParameterRoboter.setGeometry(QRect(330, 350, 261, 61))
        ...
        self.LabelPalletenplanInfo.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.label_Kartonhoehe_mm = QLabel(self.MainMenu)
        self.label_Kartonhoehe_mm.setObjectName(u"label_Kartonhoehe_mm")
        self.label_Kartonhoehe_mm.setEnabled(False)
        self.label_Kartonhoehe_mm.setGeometry(QRect(790, 200, 121, 41))
        self.label_Kartonhoehe_mm.setFont(font1)
        self.label_Kartonhoehe_mm.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.label_Gewicht_kg = QLabel(self.MainMenu)
        self.label_Gewicht_kg.setObjectName(u"label_Gewicht_kg")
        self.label_Gewicht_kg.setEnabled(False)
        self.label_Gewicht_kg.setGeometry(QRect(790, 250, 121, 41))
        self.label_Gewicht_kg.setFont(font1)
        self.label_Gewicht_kg.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.label_Gewicht = QLabel(self.MainMenu)
        self.label_Gewicht.setObjectName(u"label_Gewicht")
        self.label_Gewicht.setEnabled(False)
        self.label_Gewicht.setGeometry(QRect(80, 248, 241, 41))
        self.label_Gewicht.setFont(font1)
        self.label_Gewicht.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.label_Startlage = QLabel(self.MainMenu)
        self.label_Startlage.setObjectName(u"label_Startlage")
        self.label_Startlage.setEnabled(False)
        self.label_Startlage.setGeometry(QRect(80, 140, 241, 41))
        self.label_Startlage.setFont(font1)
        self.label_Startlage.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.EingabeStartlage.setProperty(u"showGroupSeparator", False)
        self.EingabeStartlage.setMinimum(1)
        self.EingabeStartlage.setValue(1)
        self.label_Kartonhoehe = QLabel(self.MainMenu)
        self.label_Kartonhoehe.setObjectName(u"label_Kartonhoehe")
        self.label_Kartonhoehe.setEnabled(False)
        self.label_Kartonhoehe.setGeometry(QRect(80, 194, 241, 41))
        self.label_Kartonhoehe.setFont(font1)
        self.label_Kartonhoehe.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.label_GewichtInfo = QLabel(self.MainMenu)
        self.label_GewichtInfo.setObjectName(u"label_GewichtInfo")
        self.label_GewichtInfo.setEnabled(True)
        self.label_GewichtInfo.setGeometry(QRect(330, 290, 511, 61))
        font3 = QFont()
        font3.setFamilies([u"Sans Serif"])
        font3.setPointSize(16)
        font3.setUnderline(True)
        self.label_GewichtInfo.setFont(font3)
        self.label_GewichtInfo.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.checkBoxLabelInvert = QCheckBox(self.MainMenu)
        self.checkBoxLabelInvert.setObjectName(u"checkBoxLabelInvert")
        self.checkBoxLabelInvert.setEnabled(False)
        self.checkBoxLabelInvert.setGeometry(QRect(70, 410, 251, 31))
        self.checkBoxLabelInvert.setFont(font1)
        self.checkBoxLabelInvert.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.checkBoxLabelInvert.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        self.stackedWidget.addWidget(self.MainMenu)
        self.label_GewichtInfo.raise_()
        ...
        self.label_Kartonhoehe_mm.raise_()
        self.label_Gewicht_kg.raise_()
        self.EingabePallettenplan.raise_()
        self.label_Gewicht.raise_()
        self.label.raise_()
        self.LadePallettenplan.raise_()
        self.label_Startlage.raise_()
        self.EingabeStartlage.raise_()
        self.label_Kartonhoehe.raise_()
        ...
        icon3 = QIcon()
        icon3.addFile(u":/Misc/imgs/zurueck.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.ImageAufnahmePos.setGeometry(QRect(110, 20, 390, 270))
        ...
        self.EingabeVerschiebungX.setGeometry(QRect(970, 60, 170, 41))
        ...
        self.EingabeVerschiebungY.setGeometry(QRect(970, 160, 170, 41))
        ...
        self.ButtonDatenSenden_2.setGeometry(QRect(550, 250, 590, 91))
        self.ButtonDatenSenden_2.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.checkBoxKlemmung = QCheckBox(self.Aufnahme)
        self.checkBoxKlemmung.setObjectName(u"checkBoxKlemmung")
        self.checkBoxKlemmung.setGeometry(QRect(200, 300, 221, 31))
        self.checkBoxKlemmung.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.checkBoxKlemmung.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        self.checkBoxKlemmung.setAutoFillBackground(False)
        self.checkBoxKlemmung.setStyleSheet(u"border-color: rgb(0, 0, 0);")
        ...
        self.formLayout_2.setLabelAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        ...
        self.formLayoutWidget_4.setGeometry(QRect(690, 10, 845, 341))
        ...
        self.ButtonZurueck_8.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.MatplotLibCanvasFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.MatplotLibCanvasFrame.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.LadePallettenplan_2.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.LadePallettenplan_2.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        ...
        self.lineEditFilterWidth.setInputMethodHints(Qt.InputMethodHint.ImhDigitsOnly)
        ...
        self.lineEditFilterLength.setInputMethodHints(Qt.InputMethodHint.ImhDigitsOnly)
        ...
        self.lineEditFilterHeight.setInputMethodHints(Qt.InputMethodHint.ImhDigitsOnly)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_Kartonhoehe_mm.setText(QCoreApplication.translate("Form", u"<html><head/><body><p>mm</p></body></html>", None))
        self.label_Gewicht_kg.setText(QCoreApplication.translate("Form", u"<html><head/><body><p>kg</p></body></html>", None))
        self.EingabePallettenplan.setPlaceholderText(QCoreApplication.translate("Form", u"z.B: 699-00120", None))
        self.label_Gewicht.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"right\">Gewicht: </p></body></html>", None))
        ...
        self.label_Startlage.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"right\">Startlage: </p></body></html>", None))
        self.label_Kartonhoehe.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"right\">Kartonh\u00f6he: </p></body></html>", None))
        self.label_GewichtInfo.setText("")
...
"Application", None))
        ...
        self.pushButtonSendCommandRemoteControl.setText(QCoreApplication.translate("Form", u"Send", None))
        self.comboBoxCommandRemoteControl.setItemText(0, QCoreApplication.translate("Form", u"power on", None))
        self.comboBoxCommandRemoteControl.setItemText(1, QCoreApplication.translate("Form", u"brake release", None))
        self.comboBoxCommandRemoteControl.setItemText(2, QCoreApplication.translate("Form", u"play", None))
        self.comboBoxCommandRemoteControl.setItemText(3, QCoreApplication.translate("Form", u"stopj(5.0)", None))
        self.comboBoxCommandRemoteControl.setItemText(4, QCoreApplication.translate("Form", u"movej([1.760289, -1.055588, 2.78382, -1.897801, 1.23872, 3.215636]), a=0.5, v=0.3", None))
