...
MultipackParser is a bridge application that connects **Multipack** (a software that generates palette plans) with custom palletizing applications running on Universal Robots (UR10/UR20). 

The workflow is as follows:
1. **Multipack** software generates palette plans from scratch based on input parameters (box dimensions, palette dimensions, etc.) and creates CSV files
